...
class DepgraphJavaEnvBothJson29N(gym.Env):
    """
    ...
    def _step(self, action):
        ...
        both_obs, is_done, state_dict, is_def_turn_local = \
            DepgraphJavaEnvBothJson29N.step_result_from_flat_list(
    ...
    def print_json(self):
        '''
        Print Json description of events during run to file.
        '''
        JAVA_GAME.printJsonToFile()
